...
const StripeReview = ({ cart }: { cart: any }) => {
  ...
  const handlePaymentConfirmation = async () => {
    ...
    try {
      ...
      // Ensure metadata is properly structured for `updateCart`
      const metadata = {
        metadata: {
          stripe_payment_intent_id: paymentIntent.id, // Correct metadata structure
        },
      };
      // Call updateCart() and pass metadata properly
...
function addMetadataToCart(id: any, id1: string) {
